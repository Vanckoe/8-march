      ...
      <div className="flex flex-col md:flex-row gap-5 items-stretch">
        ...
        <div className="flex flex-col md:w-1/2 bg-[#F7F7F7] px-8 py-10">
          ...
          <p className="text-base font-semibold mt-[10px] mb-5">
            ...
            {/* Мы используем современные геофизические и геологические технологии, проверенные в международной практике */}
          </p>
        </div>
      </div>
      <div className="flex flex-col md:flex-row gap-5 items-stretch">
        <div className="flex flex-col md:w-1/2 bg-[#F7F7F7] px-8 py-10">
          ...
          <p className="text-base font-semibold mt-[10px] mb-5">
            {t("processCompliance")}
            {/* Весь процесс исследования соответствует экологическим стандартам, что минимизирует воздействие на природу */}
          </p>
        </div>
        <div className="flex flex-col md:w-1/2 bg-[#F7F7F7] px-8 py-10">
          <Users />
          ...
          <p className="text-base font-semibold mt-[10px] mb-5">
            {t("experiencedTeam")}
            {/* Наша команда состоит из опытных геологов и инженеров, готовых выполнить работы на высшем уровне */}
          </p>
        </div>
      </div>
    </div>
